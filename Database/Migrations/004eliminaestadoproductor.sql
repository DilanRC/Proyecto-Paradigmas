...
--
-- Orden obligatorio: ejecutar DESPUÉS de 003personacapacidades.sql. Esa
-- migración unifica la identidad en tbpersona y deja tbproductor con
-- (tbproductorid, tbpersonaid, tbproductorestado); esta retira la última.
--
...
--     < Database/Migrations/004eliminaestadoproductor.sql
