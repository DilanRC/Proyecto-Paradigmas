...
|---|---|---|
| `comprobacionestructura.sql` | `DESCRIBE` de las 34 tablas y ausencia de llaves, índices, valores automáticos y objetos programables | estructura declarada y cero filas en las consultas de metadatos |
