...
CREATE TABLE `tbproductoresdireccion` (
  ...
  PRIMARY KEY (`tbproductoresIdentificacionNumero`),
  CONSTRAINT `fk_tbproductoresdireccion_productor` FOREIGN KEY (`tbproductoresIdentificacionNumero`) REFERENCES `tbproductores` (`tbproductoresIdentificacionNumero`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `tbproductoresfinca` (
  ...
  CONSTRAINT `fk_tbproductoresfinca_productor` FOREIGN KEY (`tbproductoresIdentificacionNumero`) REFERENCES `tbproductores` (`tbproductoresIdentificacionNumero`) ON DELETE RESTRICT ON UPDATE RESTRICT,
