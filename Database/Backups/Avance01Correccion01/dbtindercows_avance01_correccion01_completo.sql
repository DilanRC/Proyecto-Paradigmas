...
CREATE TABLE `tbproductoresdireccion` (
  ...
  `tbproductoresdireccionPueblo` varchar(150) DEFAULT NULL,
  `tbproductoresdireccionSenas` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`tbproductoresIdentificacionNumero`),
  CONSTRAINT `fk_tbproductoresdireccion_productor` FOREIGN KEY (`tbproductoresIdentificacionNumero`) REFERENCES `tbproductores` (`tbproductoresIdentificacionNumero`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `tbproductoresfinca` (
  ...
  PRIMARY KEY (`tbproductoresIdentificacionNumero`,`tbproductoresfincaNombre`),
  KEY `idx_tbproductoresfinca_nombre` (`tbproductoresfincaNombre`),
  CONSTRAINT `fk_tbproductoresfinca_productor` FOREIGN KEY (`tbproductoresIdentificacionNumero`) REFERENCES `tbproductores` (`tbproductoresIdentificacionNumero`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
-- Dump completed on 2026-08-02  9:37:43
