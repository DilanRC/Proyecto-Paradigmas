...
$check(substr_count($schema, 'CREATE TABLE IF NOT EXISTS') === 32, 'Deben existir exactamente treinta y dos CREATE TABLE');
...
$check(str_contains($migration, 'supabase_schema_status=ready tables=32 migration=v7'), 'Falta traza operativa');
...
echo "OK supabase schema_test: treinta y dos tablas, persona compartida, históricos, comercio, RLS y validación estricta.\n";
