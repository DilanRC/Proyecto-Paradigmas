...
$check(substr_count($schema, 'CREATE TABLE IF NOT EXISTS') === 11, 'Deben existir exactamente once CREATE TABLE');
...
$check(str_contains($migration, 'supabase_schema_status=ready tables=11 migration=v3'), 'Falta traza operativa');
...
echo "OK supabase schema_test: once tablas idempotentes, RLS, normalización y validación estricta.\n";
