...
$tables = ['tbproductor', 'tbproductordireccion', 'tbfinca', 'tbbitacora'];
...
$check(substr_count($schema, 'CREATE TABLE IF NOT EXISTS') === 4, 'Deben existir exactamente cuatro CREATE TABLE');
...
$check(str_contains($migration, 'supabase_schema_status=ready tables=4 migration=v1'), 'Falta traza operativa');
...
echo "OK supabase schema_test: cuatro tablas idempotentes, RLS y validación estricta.\n";
