...
$checks = [
    'treinta_y_dos_tablas' => substr_count($schema, 'CREATE TABLE IF NOT EXISTS') === 32,
    ...
    'rest_bloqueado_por_rls' => substr_count($schema, 'ENABLE ROW LEVEL SECURITY') === 32,
    ...
    'traza_operativa' => str_contains($migration, 'supabase_schema_status=ready tables=32 migration=v7'),
