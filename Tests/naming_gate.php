...
foreach (['tbparticipante ', 'tbrol ', 'tbidentificaciontipo ', 'CREATE TABLE IF NOT EXISTS tbfinca'] as $obsolete) {
...
echo "OK naming_gate: cuatro tablas, PK natural y ausencia del modelo descartado.\n";
