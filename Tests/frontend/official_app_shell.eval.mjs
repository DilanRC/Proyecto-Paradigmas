...
const checks = [
    ...
    ['explorar_lee_catalogo_real', read('Public/js/explore.js').includes('api/v1/publicaciones')
        && !explore.includes('contenido de muestra')],
    ['login_navegable', home.includes('href="entrar"') && login.includes('id="formulario-login"')],
