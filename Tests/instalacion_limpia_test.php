...
// -----------------------------------------------
// 1. Las 34 tablas canónicas del manifest existen en la base.
// -----------------------------------------------
...
test_same($manifest['tables_sorted'], $existentes,
    'La base viva contiene exactamente las 34 tablas canónicas del SQL (puerta de esquema OK).');
...
echo "OK instalacion_limpia_test: semilla maestra idempotente, 34 tablas vivas, sin huérfanos ni IDs "
