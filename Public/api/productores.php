...
foreach (['NamedLock', 'PersonaTelefonoHistorico', 'Persona', 'ProductorFinca', 'Direccion', 'ProductorDireccion', 'FincaDireccion', 'Bitacora', 'Productor', 'ProductorEstadoPeriodo'] as $modelo) {
