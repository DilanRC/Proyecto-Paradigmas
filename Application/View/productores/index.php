        ...
        <form id="formulario-productor" novalidate aria-busy="false">
            ...
            <div class="modal__content">
                ...
                <fieldset><legend>Dirección principal</legend><div class="form-grid">
                    ...
                    <label class="field"><span>Distrito <b aria-hidden="true">*</b></span><input id="direccion-distrito" name="direccionPrincipal.distrito" maxlength="100" required list="lista-distritos" autocomplete="off" aria-describedby="error-direccion-distrito"><datalist id="lista-distritos"></datalist><small class="field__error" id="error-direccion-distrito" data-error-for="direccionPrincipal.distrito"></small></label>
                    <label class="field"><span>Pueblo</span><input id="direccion-pueblo" name="direccionPrincipal.pueblo" maxlength="150" list="lista-pueblos" autocomplete="off" aria-describedby="error-direccion-pueblo"><datalist id="lista-pueblos"></datalist><small class="field__error" id="error-direccion-pueblo" data-error-for="direccionPrincipal.pueblo"></small></label>
        ...
        <form id="formulario-direccion-finca" novalidate aria-busy="false">
            ...
            <div class="modal__content">
                <fieldset><legend>Dirección</legend><div class="form-grid">
                    ...
                    <label class="field"><span>Distrito <b aria-hidden="true">*</b></span><input id="finca-direccion-distrito" name="direccionFinca.distrito" maxlength="100" required list="lista-distritos-finca" autocomplete="off" aria-describedby="error-finca-direccion-distrito"><datalist id="lista-distritos-finca"></datalist><small class="field__error" id="error-finca-direccion-distrito" data-error-for="direccionFinca.distrito"></small></label>
                    <label class="field"><span>Pueblo</span><input id="finca-direccion-pueblo" name="direccionFinca.pueblo" maxlength="150" list="lista-pueblos-finca" autocomplete="off" aria-describedby="error-finca-direccion-pueblo"><datalist id="lista-pueblos-finca"></datalist><small class="field__error" id="error-finca-direccion-pueblo" data-error-for="direccionFinca.pueblo"></small></label>
