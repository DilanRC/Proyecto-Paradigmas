    ...
    <main class="rural-panel__main">
        ...
        <div class="rural-panel__content">
            ...
            <section class="dashboard-hero" aria-labelledby="page-title">
                ...
                <div class="dashboard-hero__image"><img src="assets/dashboard/costa-rica-finca-ganadera.png" alt="Ganado en una finca verde de Costa Rica, con montañas al fondo"></div>
            </section>
            ...
            <section class="dashboard-grid">
                <article class="dashboard-card dashboard-card--feature"><div class="dashboard-card__image"><img src="assets/dashboard/costa-rica-subasta-ganadera.png" alt="Feria ganadera costarricense con animales en un corral y personas observando"></div><div class="dashboard-card__body"><span class="label">Contexto ganadero</span><h2>Preparados para conectar oportunidades reales.</h2><p>La administración reúne personas, fincas, transporte y publicaciones para que cada operación tenga un lugar claro.</p><a class="text-link" href="admin/transportistas">Revisar logística <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a></div></article>
