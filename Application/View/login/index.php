    ...
    <main class="login-shell" aria-labelledby="login-title">
        <section class="login-panel">
            <a class="login-brand" href="./" aria-label="Volver a TinderCows">
                <span class="brand__logo brand__logo--dark"><img src="assets/logo_dark.png" alt=""></span>
        ...
        <section class="login-context" aria-label="Resumen del sistema">
            <span class="brand__logo brand__logo--light"><img src="assets/logo_light.png" alt="TinderCows"></span>
