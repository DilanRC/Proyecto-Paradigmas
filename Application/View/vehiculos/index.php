...
<body class="rural-panel">
        ...
        <div class="rural-panel__content">
            ...
            <section class="panel" aria-label="Lista de vehículos" aria-busy="true" id="panel-vehiculos">
                ...
                <div class="table-container">
                    ...
                    <div class="error-state" id="estado-error" hidden><span class="error-state__icon" aria-hidden="true">!</span><h2>No fue posible cargar los vehículos</h2><p id="mensaje-error"></p><button class="button button--secondary" id="reintentar" type="button">Reintentar</button></div>
    ...
    <dialog class="modal" role="dialog" aria-modal="true" id="modal-vehiculo" aria-labelledby="titulo-modal">
