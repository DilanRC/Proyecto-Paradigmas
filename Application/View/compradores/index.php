...
<head>
    ...
    <script src="js/compradores.js" defer></script>
</head>
<body class="rural-panel">
    ...
    <main class="rural-panel__main">
        ...
        <div class="rural-panel__content">
            ...
            <section class="page-header" aria-labelledby="page-title">
                <div><span class="label">Registro de compradores</span><h1 id="page-title">Compradores</h1><p>Administre compradores identificados por su número, contacto y estado.</p></div>
            ...
            <section class="panel" aria-label="Lista de compradores" aria-busy="true" id="panel-compradores">
                ...
                <div class="table-container">
                    ...
                    <div class="empty-state" id="estado-vacio" hidden><span class="empty-state__icon" aria-hidden="true">♧</span><h2>No se encontraron compradores</h2><p>Modifique la búsqueda o cree el primer comprador.</p></div>
    ...
    <dialog class="modal" id="modal-comprador" aria-labelledby="titulo-modal">
