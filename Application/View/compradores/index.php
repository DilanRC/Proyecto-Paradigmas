...
<body class="rural-panel">
    ...
    <main class="rural-panel__main">
        ...
        <div class="rural-panel__content">
            ...
            <section class="panel" aria-label="Lista de compradores" aria-busy="true" id="panel-compradores">
                <div class="tools">
                    <label class="search"><span class="screen-reader-only">Buscar comprador</span><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="11" cy="11" r="7"/><path d="m16 16 4 4"/></svg><input id="busqueda-comprador" type="search" autocomplete="off" placeholder="Buscar por nombre, alias o identificación"></label>
                </div>
                ...
                <div class="table-container">
                    <table><thead><tr><th>Comprador</th><th>Alias</th><th>Identificación</th><th>Contacto</th><th>Estado</th></tr></thead><tbody id="cuerpo-compradores"></tbody></table>
                    <div class="empty-state" id="estado-vacio" hidden><span class="empty-state__icon" aria-hidden="true">♧</span><h2>No hay compradores registrados</h2><p>El contexto Comprador debe provenir del proceso de negocio correspondiente; este panel no permite crearlo manualmente.</p></div>
                    ...
                    <div class="skeleton" id="estado-carga" aria-hidden="true"><div class="skeleton__row"></div><div class="skeleton__row"></div><div class="skeleton__row"></div><div class="skeleton__row"></div><div class="skeleton__row"></div></div>
                </div>
            </section>
            <p class="rural-panel__footnote">Vista de solo lectura · Fuente: <code>tbcomprador + tbpersona</code> · TinderCows</p>
        </div>
    </main>
    ...
    <dialog class="modal" role="dialog" aria-modal="true" id="modal-detalle" aria-labelledby="titulo-detalle">
        ...
        <div class="modal__content">
            ...
            <section class="capacidades" aria-labelledby="titulo-capacidades">
                ...
                <p class="capacidades__nota">La misma identidad puede participar como Productor, Comprador y/o Transportista sin duplicar sus datos personales.</p>
    ...
    <div class="toast-region"><div class="toast" id="toast-status" role="status" aria-live="polite"></div><div class="toast" id="toast-alert" role="alert" aria-live="assertive"></div></div>
</body>
</html>
