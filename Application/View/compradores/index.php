...
<head>
    ...
    <meta name="description" content="Administración de compradores de TinderCows">
    ...
    <main class="rural-panel__main">
        ...
        <div class="rural-panel__content">
            ...
            <section class="page-header" aria-labelledby="page-title">
                <div><span class="label">Registro de compradores</span><h1 id="page-title">Compradores</h1><p>Administre a quienes compran ganado. Una misma persona puede además ser productor o transportista.</p></div>
                <button class="button button--primary" id="crear-comprador" type="button"><span aria-hidden="true">＋</span>Crear comprador</button>
            </section>

            <section class="panel" aria-label="Lista de compradores" aria-busy="true" id="panel-compradores">
                <div class="tools">
                    <label class="search"><span class="screen-reader-only">Buscar comprador</span><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="11" cy="11" r="7"/><path d="m16 16 4 4"/></svg><input id="busqueda-comprador" type="search" autocomplete="off" placeholder="Buscar por nombre o identificación"></label>
                ...
                <div class="list-summary">
                    <p id="total-compradores" aria-live="polite">Cargando compradores…</p>
                ...
                <div class="table-container">
                    <table><thead><tr><th>Comprador</th><th>Identificación</th><th>Contacto</th><th>Estado</th><th><span class="screen-reader-only">Acciones</span></th></tr></thead><tbody id="cuerpo-compradores"></tbody></table>
                    <div class="empty-state" id="estado-vacio" hidden><span class="empty-state__icon" aria-hidden="true">♧</span><h2>No se encontraron compradores</h2><p>Modifique la búsqueda o cree el primero.</p></div>
            ...
            <p class="rural-panel__footnote">Directorio de compradores · Datos protegidos por TinderCows</p>
        </div>
    </main>

    <dialog class="modal" role="dialog" aria-modal="true" id="modal-comprador" aria-labelledby="titulo-modal">
        <form id="formulario-comprador" novalidate aria-busy="false">
            <div class="modal__header"><div><span class="label" id="subtitulo-modal">Nuevo registro</span><h2 id="titulo-modal">Crear comprador</h2></div><button class="close-button" id="cerrar-modal" type="button" aria-label="Cerrar formulario">×</button></div>
