...
con endpoint y modelo por compatibilidad legacy; P0-C define que la
clasificación Comprador del negocio debe derivarse del Productor. Ningún valor
recibido por HTTP se concatena al SQL. Tras
