...
- [DER en PDF](DER.pdf)
- [Diccionario de datos en PDF](DiccionarioDatos.pdf)
- [Decisiones en PDF](Decisiones.pdf)
...
Los archivos de `Avance01`, `Avance01Correccion01` y
`Avance01Correccion02` y `Avance01Correccion03` son históricos. Corrección 04
usa un respaldo separado.
